    ...
    // if (!mockData.list) {
        ...
        for (let i = 0; i < 200; i++) {
            mockData.list.push({
                ...
                noTaxAmount: i * 0.9,
                tax: i * 0.1,
                billingDate: '2017-9-18',
                isQualification: (i%2 == 0) ? '√' : 'X',
                certificationMonth: '2017-9-18',
                deductibleInputTax: i * 0.05,
                isDeduct: (i%2 == 0) ? '√' : 'X',
                taxRate: '10%',
                amount: i,
                department: 'XX部门00' + i,
                ...
                alipay: i * 5,
                weChat: i * 2,
                prePaymentReceivable: i * 3,
                underSupplier: i * 5,
                lendingToEmployees: i * 2,
